...
public interface SeriesStadisticsOptions 
{
	 ...
	 */
	public static void serieByDirectors(Scanner scanner,Series[] arraySeriesGeneral) 
	{
	 ...
	 * @param scanner
	 */
	public static void serieBySubtitles(Series[] arraySeriesGeneral, Scanner scanner) 
	{
